                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="" class="nav-item nav-link">email verification</a>

                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages <i class="fa fa-angle-down mt-1"></i></a>
                                <div class="dropdown-menu bg-warning rounded-0 border-0 m-0">
                                    <a href="" class="nav-item nav-link active" style="color: black">Cart</a>
                                    <a href="" class="nav-item nav-link active" style="color: black">Checkout</a>
                                </div>
